...
def validfinal(model, device, dataset, view, data_size, epoch):
    ...
    #print('Epoch-base = {:d} =====>>>>> ACC = {:.4f} NMI = {:.4f} ARI = {:.4f} PUR={:.4f}'.format(epoch, acc, nmi, ari, pur))
